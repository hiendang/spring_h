...
tsnedata <- read_csv("tsne.out.csv")
train <- cbind(train, tsnedata[1:145231,])
test <- cbind(test, tsnedata[145232:290463,])
...
for (i in 1:3){
	...
	write_csv(submission, paste("xgb4.binary_logistic.csv.",i,sep = "_"))
	...
	cat("saving the submission file\n")
	write_csv(submission, paste("xgb4.multisoftprob.csv.",i,sep="_"))
}
